...
class MotionFgnn(nn.Module):
    ...
    def __init__(self,node_dim=128,factor_dim=128,edge_dim=16):
    ...
    def get_factor_feats(self, node_feats, n):
        ...
        # return torch.max(node_feats[idx],dim=1)[0]
...
class BasenetFgnn(nn.Module):
    """
    main module of base model for CI dataset
    """
    def __init__(self, cfg):
        super(BasenetFgnn, self).__init__()
        self.cfg=cfg
