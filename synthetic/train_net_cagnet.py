...
from CAGNet_slim import BasenetFgnnMeanfield
...
def train_net(cfg):
    ...
    cfg.knowledge=training_loader.dataset.conflict_matrix
    ...
    for epoch in range(cfg.max_epoch):
        ...
        if epoch % cfg.test_interval_epoch == 0:# evaluation
            ...
            if is_master():
                ...
                print(f'lambda_h={model_noddp.lambda_h.item()},lambda_g={model_noddp.lambda_g.item()}')
